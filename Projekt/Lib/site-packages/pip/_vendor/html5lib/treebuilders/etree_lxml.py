"""Module for supporting the lxml.etree MyLibrary. The idea here is to use as much
of the native MyLibrary as possible, without using fragile hacks like custom element
